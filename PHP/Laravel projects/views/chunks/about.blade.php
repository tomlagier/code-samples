	...
	<div class="row slider-slides" id="services-slider-slides">
		<div class="slide-wrapper">
			...
			<div class="slide" id="services-slide-1">
				...
				<div class="medium-4 columns offix service-image" id="service-image-1"></div>

				<!-- Slide text -->

				<div class="medium-8 columns offix home-service-text" id="service-text-1">
					<h2>Creative</h2>
					<p>We are fueled by creativity & humanity. Our success in the creative space is based on our consistent drive toward tangible results and the need to manufacture ideas and visuals that compel action and change.
						<ul>
			...
			<div class="slide" id="services-slide-2">
				...
				<div class="medium-4 columns offix service-image" id="service-image-2"></div>
	
				<!-- Slide text -->

				<div class="medium-8 columns offix home-service-text" id="service-text-2">
					<h2>Strategy</h2>
					<p>An approach to anything must be thoughtful, or it is nothing. People have to feel something before they will act. Then they will trade their action in exchange for something valuable: Community. Entertainment. Recognition. Information. Prizing. Cause.
						<ul>
			...
			<div class="slide" id="services-slide-3">
				...
				<div class="medium-4 columns offix service-image" id="service-image-3"></div>

				<!-- Slide text -->

				<div class="medium-8 columns offix home-service-text" id="service-text-3">
					<h2>Technology</h2>
					<p>We believe in creating experiences between brands and people, bridges of authentic communication. Technology plays a foundational role in that connection by superseding traditional and physical boundaries and allowing real two-way conversation.
						<ul>
